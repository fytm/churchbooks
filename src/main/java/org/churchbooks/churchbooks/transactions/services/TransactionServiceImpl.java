...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public List<Transactions> saveFromOFX(URL ofxPath) throws IOException, URISyntaxException, OFXParseException {
    ...
    @Override
    public Transactions save(CreateTransactionDTO createTransactionDTO) {
        Transactions transactions = Transactions.fromRequest(createTransactionDTO);
